...
1 case(s) still fail, listed at the bottom.
...
| | before | after |
|---|---:|---:|
| latency, mean | 3.00s | 2.75s |
| latency, p95 | 6.06s | 6.82s |
...
| case | check | failed |
|---|---|---:|
| `pii-card-number` | `no_competitor` | 3/3 |
